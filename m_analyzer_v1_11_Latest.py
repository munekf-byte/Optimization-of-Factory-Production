...
RAW_DATA_SHEET  = "生データ"
OUTPUT_SHEET    = "機種別分析" # ここに結果が書き込まれます
TARGET_STORE    = "ピーアーク北千住SSS" 
TARGET_MODEL    = "Lパチスロ革命機ヴァルヴレイヴ" # 分析したい機種名をここに
...
# ==========================================
# BLOCK: 3. 分析・データ作成エンジン
# ==========================================
async def run_analysis():
    print(f"\n--- [ {TARGET_MODEL} 最終解析を開始 ] ---")
