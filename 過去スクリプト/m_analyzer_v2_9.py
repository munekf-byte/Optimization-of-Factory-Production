# --- VERSION: m_analyzer_v2.9_Final_Strike_Edition_20260129 ---
...
async def run_analysis():
    ...
    try:
        ...
        for c_idx in range(6, 14): # MA(7)とMA(15)の計8本
            series.append({
                "series": {"sourceRange": {"sources": [{"sheetId": s_id, "startRowIndex": 1, "endRowIndex": l_row, "startColumnIndex": c_idx, "endColumnIndex": c_idx+1}]}},
