# --- VERSION: m_collector_v2.7_20260128 ---
...
async def get_new_tasks(page, store_url, store_name, existing_dates):
    print(f"[{store_name}] 記事リストを読み込み中（揺らし動作）...")
    ...
    try:
        await page.wait_for_selector('article h2, h2 a', timeout=10000)
    except:
        print("  [警告] 記事エリアが見つかりません。")
    ...
    async with async_playwright() as p:
        ...
        for store in TARGET_STORES:
            ...
            try:
                ...
                print(f"--- 判定終了: 合計 {len(new_tasks)} 件を新規取得します ---")
