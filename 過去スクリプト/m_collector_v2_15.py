# --- VERSION: m_collector_v2.15_20260128_Resume_Master ---
...
# ==========================================
# BLOCK: 3. 偵察ロジック（レジューム対応）
# ==========================================
async def get_filtered_tasks(page, store_url, store_name, existing_dates):
    ...
    async with async_playwright() as p:
        ...
        for store in TARGET_STORES:
            ...
            try:
                ...
                # 【重要】現在のシートの履歴を読み取る（これで続きから判断）
                print("  シートの既存データを読み込み中...")
                existing_dates = cal_sheet.col_values(1)

                tasks = await get_filtered_tasks(page, store['url'], store['name'], existing_dates)
